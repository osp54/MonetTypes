...
---@deprecated @Нету в MonetLoader`ере
...
---@deprecated @Нету в MonetLoader. Используйте https://t.me/c/1971006952/23193
...
---@overload fun(eventName: '"onTouch"', callback: fun(type:number, id:number, x:number, y:number))
